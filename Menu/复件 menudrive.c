...
struct MENU   MyMenu[]={
  ...
  {2,"3,整组测量"     , 10  ,NULL           , NULL              ,&MyMenu[1]          ,&MyMenu[3]    ,1,TotalGrpMeasure},//2
  {3,"4,查询数据"     , 10  ,NULL           ,NULL               ,&MyMenu[2]          ,&MyMenu[4]    ,1,SqlData},//3
  ...
  //二级菜单
  {0,"2.1随机测量"    , 11  ,NULL           ,&MyMenu[1]         ,NULL                ,&MyMenu[11]   ,1,RandomMenure},//10
  ...
  {1,"5.2WIFI控制"    , 11  ,NULL           ,&MyMenu[4]         ,&MyMenu[13]         ,&MyMenu[15]   ,1,OpenWifi},//14
  {2,"5.3USB控制"     , 10  ,NULL           ,&MyMenu[4]         ,&MyMenu[14]         ,NULL          ,1,NULL},//15
  //三级菜单
  {0,"1.1.1IP地址"    , 11  ,NULL           ,&MyMenu[5]         ,NULL                ,&MyMenu[17]   ,1,SetIp},//16
  {1,"1.1.2子网掩码"  , 13  ,NULL           ,&MyMenu[5]         ,&MyMenu[16]         ,&MyMenu[18]   ,1,SetIp},//17
  {2,"1.1.3网关"      , 9  ,NULL           ,&MyMenu[5]         ,&MyMenu[17]         ,NULL          , 1,SetIp},//18
  //三级菜单
  ...
  //三级菜单
  {0,"1.3.4基准内阻"  , 13  ,NULL           ,&MyMenu[7]         ,&MyMenu[22]         ,&MyMenu[24]   ,2,SetResLevel},//23
